    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center px-6 md:px-12 bg-background overflow-hidden selection:bg-white/20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-[800px] h-[800px] bg-white rounded-full blur-[200px]"
        />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col text-left">
            ...
            <motion.p
              ...
              className="text-sm md:text-lg font-mono text-gray-400 max-w-lg mb-12 leading-relaxed tracking-wide uppercase"
            >
