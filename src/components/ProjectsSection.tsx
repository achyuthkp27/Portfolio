...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="relative bg-transparent py-24 px-6 md:px-12" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto mb-16">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold">
            ...
            <TextReveal type="blur-reveal" delay={0.4} as="span" className="text-white/40">Projects</TextReveal>
          </h2>
          <TextReveal type="fade-up" delay={0.4} as="p" className="mt-4 text-muted-foreground max-w-2xl mx-auto backdrop-blur-sm">
