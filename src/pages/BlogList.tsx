...
import { ArrowUpRight, ExternalLink, BookOpen, Clock, Terminal, X } from "lucide-react";
...
const BlogList = () => {
    ...
    return (
        ...
        >
            <SEO title="Blog | Achyuth KP" description="Technical insights from Medium — distributed systems, frontend performance, and software architecture." />
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
                        <div className="relative">
                            ...
                            <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold text-white tracking-tighter uppercase leading-none">
